...
<div class="container mt-3">
    <div style="display:flex;flex-direction:row;justify-content:space-between">
        <h2 style="color:#922521;font-weight:600">MoUs</h2>
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align:center"><?php echo($row["mou_year"]) ?></td>
                <td style="text-align:center"><a target="blind" href="/static/uploads/mou/<?php echo($row["pdf"]) ?>">Click here</a></td>
                <td style="text-align:center">
                    <form onsubmit="document.getElementById('loader').style.display='block'" action="/admin/delete/mou.php" method="post">
            ...
            <tr>
                <td colspan=6 style="text-align:center">No MoU Details found !</td>
            </tr>
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title">Add MoU</h4>
            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
        </div>
        <div class="modal-body">
            <form action="/admin/create/mou.php" onsubmit="document.getElementById('loader').style.display='block'" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Company Name <span style="color:red">*</span>:</label>
                    <textarea maxlength="500" required name="name" class="form-control" placeholder="Company Name ..." id="exampleFormControlTextarea1" rows="2"></textarea>
                </div>

                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Description <span style="color:red">*</span>:</label>
                    <textarea maxlength="500" required name="content" class="form-control" placeholder="MoU Details ..."  id="exampleFormControlTextarea1" rows="2"></textarea>
                </div>

                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Year <span style="color:red">*</span>:</label>
                    <input required type="number" class="form-control" min="2000" placeholder="2017" max="2099" step="1" name="mou_year" />
                </div>

                <div class="mt-3 mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">MoU File ( PDF ) <span style="color:red">*</span>:</label>
