...
<div class="container mt-3">
    <div style="display:flex;flex-direction:row;justify-content:space-between">
        <h2 style="color:#922521;font-weight:600">NEWS</h2>
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align:center"><a target="blind" href="/static/uploads/<?php echo($row["pdf"]) ?>">Click here</a></td>
                <td style="text-align:center">
                    <form onsubmit="document.getElementById('loader').style.display='block'" action="/admin/delete/news.php" method="post">
            ...
            <tr>
                <td colspan=5 style="text-align:center">No News Details found !</td>
            </tr>
