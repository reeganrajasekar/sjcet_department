...
<div class="container mt-3">
    <div style="display:flex;flex-direction:row;justify-content:space-between">
        <h2 style="color:#922521;font-weight:600">Labs</h2>
    ...
    <div class="container">
        ...
        <div class="col-sm-12 col-md-4 col-lg-3 col-xl-3 mb-5">
            <div class="card shadow-sm" style="width:100%;max-height:280px;min-height:280px">
                <img class="card-img-top" style="height:150px !important;" src="/static/uploads/lab/image/<?php echo($row['img']) ?>">
                <div class="card-body" style="overflow: scroll;">
                    <h5 class="card-title"><span style="color:#922521">Title :</span> <?php echo($row['name']) ?></h5>
                    <span style="color:#922521">PDF : </span><a target="blind" href="/static/uploads/lab/<?php echo($row['pdf']) ?>">More</a>

                    <div style="display:flex;flex-direction:row;justify-content:flex-end">
                        <form action="/admin/delete/infra.php" onsubmit="document.getElementById('loader').style.display='block'" method="post">
        ...
        ?>
        <p colspan=4 style="text-align:center">No Lab Details found !</p>
        <?php
        }
        ?>
        </div>
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="/admin/create/infra.php" onsubmit="document.getElementById('loader').style.display='block'" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Lab Name <span style="color:red">*</span>:</label>
                    <textarea maxlength="500" placeholder="Lab name ..." required name="name" class="form-control" id="exampleFormControlTextarea1" rows="1"></textarea>
                </div>
                ...
                <div class="mt-3 mb-3">
                    <label for="banner" class="form-label">Image (jpg,jpeg,png and 580px X 380px) <span style="color:red">*</span>:</label>
