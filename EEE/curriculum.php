        ...
        <ul class="timeline">
          ...
          <li class="timeline-item mb-5"  data-aos="fade-up" data-aos-once="true">
            ...
            <div class="row text-muted gx-4 pt-3">
              ...
              <a href="/static/uploads/reg/reg/<?php echo $row['reg_file']?>" style="background-color:#f0f0f0;border:1px solid #ddd;border-radius:10px;box-shadow:2px 4px 6px #f0f0f0 ;padding:20px;display:block;text-align:center;text-decoration:none;font-size:20px"  target="blank" class="cur">Regulations</a>
				</div>
				<div class="col-sm-12 col-md-12 col-lg-4">
              <a href="/static/uploads/reg/sy/<?php echo $row['sy_file']?>" style="background-color:#f0f0f0;border:1px solid #ddd;border-radius:10px;box-shadow:2px 4px 6px #f0f0f0 ;padding:20px;display:block;text-align:center;text-decoration:none;font-size:20px"  target="blank" class="cur">Syllabus</a>
				</div>
				<div class="col-sm-12 col-md-12 col-lg-4">
              <a href="/static/uploads/reg/oe/<?php echo $row['oe_file']?>" style="background-color:#f0f0f0;border:1px solid #ddd;border-radius:10px;box-shadow:2px 4px 6px #f0f0f0 ;padding:20px;display:block;text-align:center;text-decoration:none;font-size:20px"  target="blank" class="cur">Open Electives</a>
				</div>
            </div>
          </li>
          <?php }} ?>
